...
public class SortDemo {
    ...
    //TODO 线性时间复杂度O(n)的排序算法：桶排序、计数排序、基数排序！三者都是稳定排序 & 外部排序！
    /**
     * 主要掌握上述线性排序算法的应用场景：
     *
     *  1）桶排序：
     *      *适用：数据量很大，但数据排序字段的取值范围很小！
     *      *比如：按年龄给100万用户排序；给10GB订单按订单金额（1 ~ 10000元）排序；
     *
     *  2）计数排序：
     *      *桶排序的特殊情况；
     *
     ...
     *
     *  3）基数排序：
     *      *使用稳定排序（桶or计数排序）对数据的每个位进行排序！
     *
     *      *比如：
     *          *100万个手机号的排序！从最低位依次使用稳定排序，直到第一位！
     *          *牛津大词典的单词排序：先把单词前面补0，使所有单词长度相同，再使用基数排序！
     */
